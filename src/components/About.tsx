            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                        For the past two years, we have operated at the intersection of performance marketing and generative AI. Having managed creative workflows for some of the fastest-growing brands in the US, we’ve moved past the 'experimental' phase of AI. Our frameworks are battle-tested, our delivery is perfected, and our results are consistent.
                    </p>
                ...
                >
                    <div className="aspect-square rounded-3xl overflow-hidden border border-white/10 relative">
                        ...
                        <img src="/mediahouse_ad.jpg" alt="About Thesis" className="w-full h-full object-cover opacity-80" />
